"""
Django settings for facilitysecurity_45955 project.
...
ROOT_URLCONF = 'facilitysecurity_45955.urls'
...
WSGI_APPLICATION = 'facilitysecurity_45955.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "facilitysecurity_45955 API",
    "DESCRIPTION": "API documentation for facilitysecurity_45955 App",
    "VERSION": "v1",
}
